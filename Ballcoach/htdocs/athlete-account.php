            ...
            <div class="col-sm-12">
              ...
              <nav id="app-navigation" class="app-navigation">
                ...
                <ul class="app-menu menu" aria-expanded="false">
                  ...
                  <li class="profile"><a href="athleteProfile.php">Profile</a></li>
                  <li class="account current"><a href="athlete-account.html">Account</a></li>
                      ...
                      <div class="panel-content">
                        ...
                        <div id="account">
                          ...
                          <div class="form-field">
                            ...
                            <input type="text" name="uname" value="<?php echo $row['user_id']; ?>" />
                          </div>
                          ...
                          <div class="form-field">
                            ...
                            <input type="password" name="psw" value="xxxxxxxx" />
                          </div>
